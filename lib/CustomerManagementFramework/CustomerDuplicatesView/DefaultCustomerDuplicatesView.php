...
class DefaultCustomerDuplicatesView implements CustomerDuplicatesViewInterface
{
    ...
    {
        if(!sizeof(Plugin::getConfig()->CustomerDuplicatesService->DuplicatesView->listFields)) {
        ...
        $fields = Plugin::getConfig()->CustomerDuplicatesService->DuplicatesView->listFields->toArray();
        $listData = [];
